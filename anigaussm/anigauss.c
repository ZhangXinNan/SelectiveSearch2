    ...
    double *filter, double tanp)
{
    ...
    buf0 = (double*)malloc((sx+sy*tanp+2)*sizeof(*buf0));
    buf1 = (double*)malloc((sx+sy*tanp+2)*sizeof(*buf1));
    buf2 = (double*)malloc((sx+sy*tanp+2)*sizeof(*buf2));
    buf3 = (double*)malloc((sx+sy*tanp+2)*sizeof(*buf3));
    ...
    double phi, int order)
{
   ...
   buf = (DSTTYPE*)malloc(sx*sizeof(*buf));
